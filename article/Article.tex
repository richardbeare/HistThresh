...
\begin{figure}[htbp]
\centering
\subfigure[Kittler Illingworth]{\includegraphics[height=5cm]{outKittlerIllingworth}}
\subfigure[Intermode]{\includegraphics[height=5cm]{outIntermodes}}
\subfigure[Intermode - minimum]{\includegraphics[height=5cm]{outMinimum}}

\subfigure[IsoData]{\includegraphics[height=5cm]{outIsoData}}
\subfigure[Monents]{\includegraphics[height=5cm]{outMoments}}
\subfigure[Triangle]{\includegraphics[height=5cm]{outTriangle}}
\caption{Thresholded images.\label{fig:bpdthreshA}}
\end{figure}

\begin{figure}[htbp]
\centering
\subfigure[Huang]{\includegraphics[height=5cm]{outHuang}}
\subfigure[Li]{\includegraphics[height=5cm]{outLi}}
\subfigure[Maximum Entropy]{\includegraphics[height=5cm]{outMaxEntropy}}

\subfigure[Renyi Entropy]{\includegraphics[height=5cm]{outRenyiEntropy}}
\subfigure[Yen]{\includegraphics[height=5cm]{outYen}}
\subfigure[Shanbhag]{\includegraphics[height=5cm]{outShanbhag}}
